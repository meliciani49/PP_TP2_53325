...
public abstract  class Actividad  implements Serializable  {
    ...
    public Inscripcion inscribir(Estudiante estudiante) throws CupoExcedidoException {
        ...
        System.out.print("Confirma la inscripción del estudiante " + estudiante.getNombre() + "  en la actividad " + this.titulo + "? : S/N  ");
        String respuesta = scanner.nextLine().trim().toLowerCase();
        if (respuesta.equals("s") || respuesta.equals("si") || respuesta.equals("sí")) {
            inscripcion.confirmar();
            System.out.println("Inscripción confirmada para el estudiante " + estudiante.getNombre() + " en la actividad " + this.titulo + ".");
        }
